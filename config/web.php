...
//        ],
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'api/changePass/<nik:\w+>/<email:[^/]+>/<newpass:\w+>' => 'api/change-password',
                ...
                'api/QueryTotalUang/<id:\d+>' => 'api/query-total-uang',
                'api/QueryTotalApprove/<nik:\d+>' => 'api/query-total-approve',
                'api/QueryTotalPengguna/<nik:\d+>' => 'api/query-total-pengguna',
                'api/QuerySisaUang/<nik:\d+>' => 'api/query-sisa-uang',
                'api/QueryTaskSPD/<nik:\d+>' => 'api/query-task-spd',
